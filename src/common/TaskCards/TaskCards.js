...
const TaskCards = ({ src, alt, title, subTitle, progressPercentage, leftDays,className }) => {
    ...
    return (
        <Box className={`${className} !bg-white !rounded-lg !py-4 lg:!px-6 !px-3`}>
            ...
            <Typography className='PlusJakartaSans600 !text-base !font-semibold !text-[--Secondary-500] !pt-2'>{title}</Typography>
            <Typography className='PlusJakartaSans500 !text-xs !text-[--Secondary-400] !font-medium'>{subTitle}</Typography>
