...
const TaskCards = ({ src, alt, title, subTitle, progressPercentage,defaultValue, leftDays, className }) => {
    const avatars = [Photo1, Photo2, Photo3, Photo4, Photo5]
    return (
        <Box className={`${className} !bg-white !rounded-lg !w-full !py-4 lg:!px-6 !px-3`}>
            ...
            <Slider className="!px-6" defaultValue={defaultValue}/>
            <Box className="!flex !justify-between">
